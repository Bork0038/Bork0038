...
```math
\ce{$\unicode[goombafont; background-color: white; height: 1000px !important; width: 1000px !important; position: relative; color:red; pointer-events: none; z-index: -10; top: 0; left: 0; object-fit: cover; background-size: cover; opacity: 0.5; background: url('https://avatars.githubusercontent.com/u/71100852?v=4');]{x0000}$}
