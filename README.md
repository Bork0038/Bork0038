...
```math
\ce{$\unicode[goombafont; background-color: white; height: 100% !important; width: 100% !important; position: absolute; color:red; pointer-events: none; z-index: -10; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 130vw; opacity: 0.5; background: url('https://avatars.githubusercontent.com/u/71100852?v=4');]{x0000}$}
